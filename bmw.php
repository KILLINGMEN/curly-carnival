...
">
            BMW — одна из крупнейших немецких компаний, выпускающая в настоящее время мотоциклы, автомобили и
            велосипеды, — была образована на базе завода авиационных двигателей, основанного в 1913 году в Мюнхене.
        </h2>
    </div>
...
<div style="padding: 20px">
    ...
    font-weight: bold;">
        ...
        <div style="display: flex; flex-direction: row">
            <a href="bmw5.php" style="display: flex; flex-direction: column; margin: 20px;">
                <div style="width: 180px; height: 112px">
                    <img src="bmwcupe.PNG" style="width: 100%">
                </div>
                BMW M5
            </a>
            <a href="bmw7.php" style="display: flex; flex-direction: column; margin:20px;">
                <div style="width: 180px; height: 112px">
                    <img src="bmwsedan.PNG" style="width: 100%">
                </div>
                BMW F7
            </a>
        </div>
